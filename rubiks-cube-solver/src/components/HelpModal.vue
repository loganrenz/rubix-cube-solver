          ...
          <div class="relative inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              ...
              <div class="mt-2 space-y-4 text-sm text-gray-600 dark:text-gray-300">
                ...
                <section>
                  <h4 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">3D Cube Controls</h4>
                  <ul class="space-y-1 list-disc list-inside">
                ...
                <section>
                  ...
                  <div class="grid grid-cols-2 gap-2 text-xs">
                    <div><code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">F</code> - Front clockwise</div>
                    <div><code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">F'</code> - Front counter-clockwise</div>
                    <div><code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">B</code> - Back clockwise</div>
                    <div><code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">B'</code> - Back counter-clockwise</div>
                    <div><code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">U</code> - Up (top) clockwise</div>
                    <div><code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">U'</code> - Up counter-clockwise</div>
                    <div><code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">D</code> - Down clockwise</div>
                    <div><code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">D'</code> - Down counter-clockwise</div>
                    <div><code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">L</code> - Left clockwise</div>
                    <div><code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">L'</code> - Left counter-clockwise</div>
                    <div><code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">R</code> - Right clockwise</div>
                    <div><code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">R'</code> - Right counter-clockwise</div>
                  </div>
                  <p class="mt-2 text-xs">
                    <strong>Note:</strong> Adding <code class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">2</code> means 180° turn (e.g., F2)
                  </p>
                </section>
