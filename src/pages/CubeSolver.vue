        ...
        <main class="container mx-auto px-4 py-6 safe-bottom">
            <div class="lg:hidden">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                    ...
                    <div class="p-4">
                        <ControlPanel v-show="activeTab === 'controls'" :solution="solution" :animation-state="animationState" :is-scrambling="isScrambling" :is-solving="isSolving" :is-solved="isSolved" :error="error" :current-move="currentMove" :cube-state="cubeState"
                        ...
                        <SolutionDisplay v-show="activeTab === 'solution'" :solution="solution" :current-step-index="animationState.currentStep - 1" />
                    </div>
                </div>
            </div>
